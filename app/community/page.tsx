...
export default async function CommunityPage() { const access = await getCommunityAccess(); if (!access.allowed) notFound(); return <div className="garrison-shell min-h-screen"><CommunityHome/></div>; }
